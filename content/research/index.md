...
[Published version](/files/papers/szocs2025tree.pdf) | [Code](https://github.com/orsiszocs/global-vs-local-ai-advice)
...
I have received rejects way more than I can handle (at the beginning) than the "publish" or "quantifieable" achievements. This includes but not only include academic publications, workshops/summer schools, internships. 

The process is hard to internalize. A medium portion of all rejection could be considered as not fitting, not reaching the bar, not "good enough". Recently, I find a way to blame more on the chaotic time/politics/global. Or pure luck.  -->
