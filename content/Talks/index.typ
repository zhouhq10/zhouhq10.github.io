...
#show: template.with(
  title: "Talks",
  description: "Invited talks and reading group presentations.",
)
...
- Adaptive strategies in continuous time causal learning | #link("/files/slides/241029_causal_learning.pdf")[Slides]
- Merits of curiosity — A simulation study | #link("/files/slides/241025_curiosity_network_presentation.pdf")[Slides]
- Exploring the hierarchical structure of human plans via program generation | #link("/files/slides/240319_hierarchical_program_induction.pdf")[Slides]
- Reverse-engineering the self | #link("/files/slides/230808_reverse_engineering_the_self.pdf")[Slides]
